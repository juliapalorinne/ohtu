...
public class Sovellus {
    ...
    private static void kuuluu() {
        ...
        boolean kuuluuko = joukko.lukuOnTaulukossa(kysLuku);
        if (kuuluuko) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("K‰ytˆss‰si ovat joukot A, B ja C.");
        System.out.println("Komennot ovat lis‰‰(li), poista(p), kuuluu(k), yhdiste(y), erotus(e), leikkaus(le) ja lopetus(quit)(q).");
        System.out.println("Joukon nimi komentona tulostaa joukon.");
