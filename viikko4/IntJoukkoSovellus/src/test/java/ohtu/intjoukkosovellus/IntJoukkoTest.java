...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.lukuOnTaulukossa(10));
        assertFalse(joukko.lukuOnTaulukossa(5));
        assertFalse(joukko.lukuOnTaulukossa(0));
        assertTrue(joukko.lukuOnTaulukossa(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.lukuOnTaulukossa(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.lukuOnTaulukossa(11));
        joukko.poista(11);
        assertFalse(joukko.lukuOnTaulukossa(11));
